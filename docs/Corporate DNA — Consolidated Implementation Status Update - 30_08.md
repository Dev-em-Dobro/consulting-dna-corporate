...
**In response to the consolidated brief of 27 Aug 2026, and to Guli's design pass of 29 Aug.** Prepared by: Dev em Dobro. Date: 2026-08-30. Scope: the public website only (the content system is a separate project that the site feeds from).

> This update supersedes the 28-08 status. The brief remains the single source of truth: where it conflicts with earlier direction on content, architecture or design, the brief wins. Where it conflicts with the design mock, we have said so explicitly rather than choosing quietly.

**Target: 1 September 2026.** Parts B and C are what stands between here and that date.
...
**Everything in Part A is on the review site now**, including the navigation change and all of Guli's 29-08 pass. Two things to know before you look, both of them ours and neither a design question:
...
1. **The eight Solutions are registered** in the content system, in the brief's order, each with the five blocks and a flagship field.
...
9. **"Keeping Leadership Real" is now explained, not just asserted.** A block sits under the hero carrying the six terms from item 1 — real pressures, real politics, real choices, real judgement, real people, real consequences — and nothing else. A framing sentence would have been invented copy. **Its visual treatment still needs Guli** — see C1. What exists is the structure working, not a finished layout.
...
### B2 · Our Impact — three definitions **[CDNA]**

The page cannot be finished without these, and none of them is a design question.

- **Which figures are correct?** The mock uses 18 years / 36 countries / 75 faculty / 90% Chairman. The old site's "By the numbers" carries **nine** different indicators.
- **Are "measurable results" and "impact statistics" the same thing, or two blocks?**
- **What are "programme outcomes" and "evidence across regions"?** Neither is defined in the brief and neither exists on the old site.

*Our reading, for you to confirm or correct:* the old site's nine figures split cleanly in two — company figures (founded, countries, leadership teams and coaching clients served, top FTSE 10) and programme results (NPS, engagement, programme impact, talent promoted). If "impact statistics" is the first group and "programme outcomes" the second, the page carries two figure bands rather than one, and "measurable results" is the umbrella over both. "Programme Impact" is already one of those nine, which is what points us this way.

### B3 · Three claims on Our Approach **[CDNA]**

**The corporate figures are settled** — item 2 of your 27-08 e-mail names "90% Chairman/CXO-sponsored" and "18 years", which is the set the homepage and Our Impact now use, alongside 36 countries and 75 faculty. Nothing there needs revisiting.

What is still open is narrower: three things on the Our Approach page, flagged on the 06-08 list and never closed.

- **"95% of our clients cite 5H® as the real secret of our success."** It is on the page today. Confirm the figure, or tell us to take it out.
- **"across 26 countries"**, in four places on that page, where every other page says **36 countries**. This is the one straight contradiction on the site: same fact, two numbers.
- **"Over ten years"**, describing how long the 5H has been in use. This may well be correct — a methodology can be younger than the firm — but it sits a click away from "18 years", and a visitor reads the two as a conflict rather than as two different facts.

None of these needs new copy. A yes, a no, or a corrected figure is enough, and applying it is a quick change on our side.
...
### B5 · Solutions content **[CDNA]**

The eight pages re-authored in the short five-block format. The fields are ready.

Also: **the flagship case for Manager Development and Executive Coaching** — the two marked TBC in item 6.

### B6 · Testimonials about Corporate DNA **[CDNA]**

Item 7 requires quotes to be testimonials about the work, not generic corporate quotes. Today's are the second kind, so the slots on Our Impact are built and held empty rather than filled with what the brief asks us to replace.
...
**If all you want is the old site's strip carried across as it stands, say so and we do it.** That is a short job on our side, not a blocker, and it does not need you to write anything new. We have not done it unasked because the old strip predates the 2023 cut the item sets, so some of it would come across and some would not, and that is your call rather than ours.

**What we genuinely cannot resolve ourselves is the links.** On the old site some ticker items were clickable. The field exists and works, so we can carry them — but a link has to lead somewhere, and for several of these there is no obvious destination on the new site. So: do the items link, and if they do, where does each one go? This is the part that was not clear to us, and it is the only thing here that actually needs an answer from you.

### B11 · Proprietary frameworks and diagnostics **[CDNA]**

Which ones go in. The structure is prepared and empty, as the brief asks.

### B12 · Two decisions **[CDNA]**
...
### B13 · How content should reach us **[CDNA]**
...
**The "Keeping Leadership Real" block.** Item 1 asks for the explanation to be "curta e visual". We built the short; the visual is his. It is standing on the current system's spacing so the block exists and CDNA can see the six terms in context — it is not a proposed layout.
...
- The remaining individual testimonial films, added through the content system.
...
**And one question we asked in the previous cycle and have not had answered:** does "launch on the 1st" mean the review site is complete, or the live domain switches over? Today `corporatednaconsulting.com` still serves the old site. The switch itself is quick — two DNS records — but it is not in any tracker, and the two readings need very different amounts of runway.
